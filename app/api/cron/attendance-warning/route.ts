...
export async function GET(request: NextRequest) {
    try {
                ...
                for (const fcm of emp.fcmTokens) {
                    messages.push({
                        ...
                        notification: {
                            ...
                            body: "Punch your attendance or else your payroll is reduced",
                        },
                        webpush: {
                            notification: {
                                title: "Attendance Reminder",
        ...
        return NextResponse.json({
            success: true,
            message: "Attendance warning cron job completed.",
            targetedEmployees,
            notificationCount: messages.length,
            sendResponse,
        });
    } catch (error: any) {
        console.error("Attendance warning cron error:", error);
        return NextResponse.json(
