...
export default function EmployeePortal() {
    ...
    const [activeTab, setActiveTab] = useState<"overview" | "intern-support" | "settings">("overview");
                        ...
                        <div>
                            <h2 className="text-xl font-semibold text-white tracking-tight">
                                {activeTab === "overview" ? "Dashboard overview" :
                                    activeTab === "intern-support" ? "Intern support system" : "Employee Profile Settings"}
                            </h2>
                            <p className="text-xs text-white/30 mt-0.5">
                                {activeTab === "overview" ? "real-time system metrics and activity" :
                                    activeTab === "intern-support" ? "manage intern technical and portal issues" : "update your personal, contact, payroll and delivery information"}
                            </p>
                        </div>
