        ...
        <section className="w-full bg-[#fafafa] font-sans py-8 sm:py-10 lg:py-12 border-t border-zinc-200/80 relative overflow-hidden">
            ...
            <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch max-w-[1020px] mx-auto">
                    ...
                    {/* Retainer Card (Dark & Premium) */}
                    <div className="bg-[#121314] border border-zinc-800 rounded-[20px] p-5 sm:p-6 flex flex-col justify-between shadow-[0_20px_40px_rgba(0,0,0,0.45)] relative overflow-hidden group hover:border-zinc-700 transition-all duration-300">
                        {/* Ambient Glow */}
                        <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-gradient-to-bl from-[#E61E32]/10 to-transparent rounded-full blur-3xl pointer-events-none" />
                        ...
                        <div>
                            ...
                            <div className="text-white text-[38px] sm:text-[44px] font-extrabold mt-4 tracking-tight flex items-baseline">
                    ...
                    {/* Fixed Scope Card (Light & Modern) */}
                    <div className="bg-white border border-zinc-200/90 rounded-[20px] p-5 sm:p-6 flex flex-col justify-between shadow-[0_15px_30px_rgba(0,0,0,0.02)] relative overflow-hidden group hover:border-zinc-300 transition-all duration-300">
                        {/* Ambient Glow */}
                        <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-gradient-to-bl from-zinc-100/60 to-transparent rounded-full blur-3xl pointer-events-none" />
                        ...
                        <div>
                            ...
                            <div className="text-zinc-900 text-[38px] sm:text-[44px] font-extrabold mt-4 tracking-tight flex items-baseline">
